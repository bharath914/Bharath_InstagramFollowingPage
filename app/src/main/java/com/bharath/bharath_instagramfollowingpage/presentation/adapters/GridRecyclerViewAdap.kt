...
class GridRecyclerViewAdap(
    val context: Context,
    val listener: RecyclerViewClickListenerGrid,
) : ListAdapter<PersonData, GridRecyclerViewAdap.GridRecyclerViewHolder>(ItemCallBackDiffUtil()) {

    inner class GridRecyclerViewHolder(itemView: View) : ViewHolder(itemView) {
        val image: CircleImageView = itemView.findViewById(R.id.GridProfileImage)
        val handleName: TextView = itemView.findViewById(R.id.GridhandleName)

        //        val userName: TextView = itemView.findViewById(R.id.userName)
        val followButton: Button = itemView.findViewById(R.id.GridfollowButton)
...
//            userName.text = personData.personName
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GridRecyclerViewHolder {
        return GridRecyclerViewHolder(
            LayoutInflater.from(context).inflate(R.layout.person_data_grid, parent, false)
        )
    }
    ...
    interface RecyclerViewClickListenerGrid {
